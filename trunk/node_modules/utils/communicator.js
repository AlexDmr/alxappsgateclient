		...
		initialize: function(argO) {
			...
			this.webSocket.on( 'connect'
							 , function(connection) {
									 ...
									 connection.on('error', function() {console.log("Connection Error: " + error.toString());});
									 connection.on('message', function(self) {return function(message) {self.handleMessage(message);}}(self));
